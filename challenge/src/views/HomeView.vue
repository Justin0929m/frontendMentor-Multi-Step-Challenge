<template>
  <div class="main-container">
    ...
    <div class="container">
      <div class="sidebar">
        <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-img" width="274" height="568" fill="none"
          viewBox="0 0 274 568">
      ...
      <div class="main-section">
        ...
        <form class="form">
          ...
          <input type="text" name="number" placeholder="e.g. +1 234 567 890">
        </form>
        <div class="form-control">
          <router-link to="/plan" class="form-btn">Next Step</router-link>
        </div>
      </div>
    </div>
  </div>
