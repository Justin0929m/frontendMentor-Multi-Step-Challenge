    ...
    <div class="main-container">
      ...
      <div class="container">
        <div class="sidebar">
          ...
          <div class="steps-container">
            ...
            <div class="steps">
              ...
              <div>
                <h1 class="step-text">Step 2</h1>
                <p class="step-title">Select plan</p>
              </div>
            </div>
            <div class="steps">
              <div class="not-active">3</div>
              <div>
                <h1 class="step-text">Step 3</h1>
                <p class="step-title">Add-ons</p>
              </div>
            </div>
            <div class="steps">
              <div class="not-active">4</div>
              <div>
                <h1 class="step-text">Step 4</h1>
        ...
        <div class="main-section">
          <h1 class="main-title">Select your plan</h1>
          <p class="main-text">You have the option of monthly or yearly billing.</p>
          ...
          <router-link to="/" class="form-btn-back">Go Back</router-link>
          <router-link to="/addons" class="form-btn-next">Next Step</router-link>
        </div>
        </div>
      </div>
